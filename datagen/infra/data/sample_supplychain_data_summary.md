...
**Generated**: 2026-03-09 14:01:35  
**Date Range**: 2025-01-01 to 2026-03-31  
**Duration**: 454 days  
**Integration**: Connected to 50,301 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 7,798
...
- **Purchase Orders**: 111 procurement orders  
- **PO Line Items**: 283 order details
...
- **Purchase Orders**: 111 orders spanning 90-day historical period
...
- `PurchaseOrders.csv` - 111 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 283 line items with specifications
...
*Generation Parameters: 111 orders, 6810 transactions, 15 events*  
