...
**Generated**: 2026-03-06 13:31:54  
**Date Range**: 2020-01-01 to 2026-03-31  
**Duration**: 2281 days  
**Integration**: Connected to 131,768 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 35,600
...
- **PO Line Items**: 598 order details
- **Inventory Transactions**: 34215 movement records
...
- **Complete Visibility**: 34215 inventory movements across all transaction types
...
- `InventoryTransactions.csv` - 34215 complete movement audit trail
- `PurchaseOrders.csv` - 200 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 598 line items with specifications
...
*Generation Parameters: 200 orders, 34215 transactions, 15 events*  
