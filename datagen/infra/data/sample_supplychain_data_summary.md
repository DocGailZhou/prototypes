...
**Generated**: 2026-03-04 14:31:14  
**Date Range**: 2025-12-01 to 2026-03-31  
**Duration**: 120 days  
**Integration**: Connected to 50,435 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 2,415
- **Suppliers**: 5 suppliers with backup relationships
- **Product-Supplier Mappings**: 5 relationships
- **Inventory Records**: 73 stock locations
- **Purchase Orders**: 50 procurement orders  
- **PO Line Items**: 47 order details
...
- `ProductSuppliers.csv` - 5 product-to-supplier mappings with pricing
...
- `PurchaseOrderItems.csv` - 47 line items with specifications
