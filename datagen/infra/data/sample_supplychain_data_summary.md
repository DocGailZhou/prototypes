...
**Generated**: 2026-03-09 14:29:59  
**Date Range**: 2025-01-01 to 2026-03-31  
**Duration**: 454 days  
**Integration**: Connected to 51,103 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 7,867
- **Suppliers**: 5 suppliers with backup relationships
- **Product-Supplier Mappings**: 72 relationships
- **Inventory Records**: 75 stock locations
- **Purchase Orders**: 113 procurement orders  
- **PO Line Items**: 357 order details
...
- **Purchase Orders**: 113 orders spanning 90-day historical period
...
- `ProductSuppliers.csv` - 72 product-to-supplier mappings with pricing
...
- `PurchaseOrders.csv` - 113 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 357 line items with specifications
...
*Generation Parameters: 113 orders, 6810 transactions, 15 events*  
