...
**Generated**: 2026-03-09 13:48:17  
**Date Range**: 2024-03-01 to 2024-03-07  
**Duration**: 6 days  
**Integration**: Connected to 43,371 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 593
...
- **Purchase Orders**: 2 procurement orders  
- **PO Line Items**: 10 order details
- **Inventory Transactions**: 90 movement records
...
- **Purchase Orders**: 2 orders spanning 90-day historical period
...
- **Complete Visibility**: 90 inventory movements across all transaction types
...
- `InventoryTransactions.csv` - 90 complete movement audit trail
- `PurchaseOrders.csv` - 2 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 10 line items with specifications
...
*Generation Parameters: 2 orders, 10 transactions, 15 events*  
