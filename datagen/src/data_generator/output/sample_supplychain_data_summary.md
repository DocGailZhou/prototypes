...
**Generated**: 2026-03-06 13:02:43  
**Date Range**: 2025-01-01 to 2026-03-31  
**Duration**: 454 days  
**Integration**: Connected to 50,526 sales line items

## 🏭 Generation Overview

### **Total Summary**
- **Total Records Generated**: 7,854
- **Suppliers**: 5 suppliers with backup relationships
- **Product-Supplier Mappings**: 74 relationships
- **Inventory Records**: 80 stock locations
- **Purchase Orders**: 112 procurement orders  
- **PO Line Items**: 338 order details
...
- **Purchase Orders**: 112 orders spanning 90-day historical period
...
- `ProductSuppliers.csv` - 74 product-to-supplier mappings with pricing
...
- `PurchaseOrders.csv` - 112 procurement orders with supplier details  
- `PurchaseOrderItems.csv` - 338 line items with specifications
...
*Generation Parameters: 112 orders, 6810 transactions, 15 events*  
